...
The API supports both delegated and application permissions, enabling flexible deployment scenarios including unattended automation and service account workflows.
