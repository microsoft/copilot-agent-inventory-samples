...
Contributions are welcome. If you have built something on top of the Copilot Package Management API and want to share it as a sample, open a pull request with your solution in a new folder under `samples/`.
